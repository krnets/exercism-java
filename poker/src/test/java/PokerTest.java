...
public class PokerTest {
    ...
    @Test
    public void doublePairVsThreeOfAKind() {
    ...
    @Test
    public void sameThreeOfAKindMultipleDecks() {
    ...
    @Test
    public void twoFullsSameTripletMultipleDecks() {
    ...
    public void twoFourOfAKind() {
        String fourOfAKindOf2 = "2S 2H 2C 8D 2D";
        String fourOfAKindOf5 = "4S 5H 5S 5D 5C";
        assertEquals(Collections.singletonList(fourOfAKindOf5),
                new Poker(Arrays.asList(fourOfAKindOf2, fourOfAKindOf5)).getBestHands());
    }

    @Test
    public void sameFourOfAKindMultipleDecks() {
    ...
    public void fiveOfAKind() {
        String fiveOfAKindAceJ = "AS AH JC AD AC";
        String fiveOfAKindQueens = "5S 5H 5S 5D 5C";
        assertEquals(Collections.singletonList(fiveOfAKindAceJ),
                new Poker(Arrays.asList(fiveOfAKindAceJ, fiveOfAKindQueens)).getBestHands());
    }
}
